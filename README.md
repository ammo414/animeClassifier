uses a logistic classifier to determine if a given anime is going to be a good fit, given a anilist profile. This showcases data gathering, model development, and model deployment.
